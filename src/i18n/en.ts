...
export const en: Messages = {
  ...
  nav: {
    ...
    connectFirst: "Connect to a relay first",
  },
  community: {
    title: "Community",
  ...
  membership: {
    ...
    knownAgentLabel: "Known agent",
    pickChannelFirstOption: "choose a channel first",
    noKnownAgentsOption: "every known agent is already in this channel",
    chooseKnownAgentOption: "choose a known agent (optional)",
  ...
  channelDetail: {
    ...
    typeLabel: "Type:",
    aboutLabel: "About:",
    firstSeen: (when) => `First observed ${when}`,
    membersTitle: (count) => `Members (${count})`,
    noMembers: "No members observed yet.",
    colMember: "Member",
    colRole: "Role",
