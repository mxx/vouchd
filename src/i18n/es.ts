...
export const es: Messages = {
  ...
  membership: {
    ...
    knownAgentLabel: "Agente conocido",
    pickChannelFirstOption: "elige primero un canal",
    noKnownAgentsOption: "todos los agentes conocidos ya están en este canal",
    chooseKnownAgentOption: "elige un agente conocido (opcional)",
  ...
  channelDetail: {
    title: (name) => `Canal: ${name}`,
    back: "Volver a los canales",
    idLabel: "ID del canal:",
    visibilityLabel: "Visibilidad:",
    typeLabel: "Tipo:",
    aboutLabel: "Acerca de:",
    firstSeen: (when) => `Observado por primera vez ${when}`,
    membersTitle: (count) => `Miembros (${count})`,
    noMembers: "Aún no se ha observado ningún miembro.",
    colMember: "Miembro",
    colRole: "Rol",
