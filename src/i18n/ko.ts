...
export const ko: Messages = {
  ...
  membership: {
    ...
    knownAgentLabel: "알려진 에이전트",
    pickChannelFirstOption: "먼저 채널을 선택하세요",
    noKnownAgentsOption: "알려진 모든 에이전트가 이미 이 채널에 있습니다",
    chooseKnownAgentOption: "알려진 에이전트 선택(선택 사항)",
  ...
  channelDetail: {
    ...
    typeLabel: "유형:",
    aboutLabel: "설명:",
    firstSeen: (when) => `${when}에 처음 확인됨`,
    membersTitle: (count) => `멤버 (${count})`,
    noMembers: "아직 발견된 멤버가 없습니다.",
    colMember: "멤버",
    colRole: "역할",
    colFirstSeen: "최초 확인",
  },
