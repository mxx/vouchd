...
export const zhHant: Messages = {
  ...
  membership: {
    ...
    pickChannelFirstOption: "請先選擇頻道",
    noKnownAgentsOption: "所有已知 agent 都已在該頻道中",
    chooseKnownAgentOption: "選擇一個已知 agent(可選)",
    pubkeyLabel: "要新增的公鑰",
    roleLabel: "角色",
    submit: "加入頻道",
  ...
  channelDetail: {
    ...
    unarchive: "取消封存",
    delete: "刪除頻道",
    deleteConfirm: (name) => `刪除「${name}」？relay 只會軟刪除,且此操作在此處無法復原。`,
  },
  agents: {
    emptyTitle: "成員",
